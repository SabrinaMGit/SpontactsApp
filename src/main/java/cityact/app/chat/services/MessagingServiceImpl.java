...
import cityact.app.chat.database.ConversationsRepository;
import cityact.app.chat.database.MessagesRepository;
...
public class MessagingServiceImpl implements MessagingService {
	...
	public Conversation getExistingConversation(Integer convId) {
		return conversationsRepo.findAllById(convId);
	}
	...
	public Conversation addMemberToConversation(Integer convId, List<String> members) {
		Conversation conversation = conversationsRepo.findAllById(convId);
